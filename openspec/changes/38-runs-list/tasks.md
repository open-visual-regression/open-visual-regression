...
Gate: `/projects/[slug]/builds` renders table with DiffStrip per row; filter tabs update the list; baseline branch info shown.
...
- [ ] 1.2 Build row component (`RunRow`):
  ...
  - Full row links to `/projects/[slug]/builds/[buildId]`
