...
- [ ] 1.1 Create `apps/web/app/(app)/projects/new/page.tsx` (`"use client"` — needs controlled input for slug derivation):
  - Fields:
...
- [ ] 1.3 Create `apps/web/app/(app)/projects/new/actions.ts`:
