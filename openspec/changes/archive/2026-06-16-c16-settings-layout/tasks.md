...
- [x] 1.1 Create `apps/web/app/(authenticated)/settings/layout.tsx`:
...
- [x] 1.2 Build `SettingsNav` in `apps/web/lib/components/settings-sidebar/`:
...
- [x] 1.3 Component test: admin user sees all sections; non-admin user does not see admin section heading or links
