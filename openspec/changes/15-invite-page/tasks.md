...
- [ ] 1.1 Create `apps/web/app/(unauthenticated)/invite/[invitationId]/page.tsx` (RSC):
...
- [ ] 1.2 Create `apps/web/app/(unauthenticated)/invite/[invitationId]/actions.ts`:
...
- [ ] 1.3 Add sign-out Server Action to `apps/web/app/(authenticated)/actions.ts`; add sign-out item to TopBar user avatar dropdown
- [ ] 1.4 Component tests:
