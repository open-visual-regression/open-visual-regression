/* global React, Icon, Button, Badge, Glyph, KeyHint, DiffStrip, MOCKS, MOCK_W, MOCK_H, PROJECTS, RUNS_BY_PROJECT, SNAPSHOTS_BY_RUN, SegmentedProgress, Toast, ToastStack */
...
// ===========================================================================
function RunDetailScreen({ project, run, onNavigate, withToast }) {
  ...
  return (
    <div style={{ padding: '24px 40px', position: 'relative' }}>
      {/* run header */}
      ...
      {/* snapshot status breakdown — segmented progress */}
      <div style={{
        ...
        <SegmentedProgress
          ...
          summary={
            counts.pending > 0
              ? `${counts.pass + counts.changed + counts.fail} / ${snapshots.length} complete`
              : `${counts.pass} / ${snapshots.length} pass`
          }
          segments={[
