...
| `OVR_STORYBOOK_CACHE_BYTES` | `2147483648` (2 GB) | Local disk for extracted Storybook builds. A build is downloaded from storage once and reused by every capture group and dashboard request that needs it. |
