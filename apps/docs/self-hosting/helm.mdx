...
| `worker.diffConcurrency` | app default `4` | Snapshots compared against their baseline at once. Memory scales with this: a comparison holds the capture, the baseline, and the diff image uncompressed. |
