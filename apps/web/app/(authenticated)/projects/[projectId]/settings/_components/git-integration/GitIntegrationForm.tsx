...
const SELF_HOSTED: GitProviderSchema[] = ["github_enterprise", "gitea", "forgejo"];

const gitIntegrationSchema = z
  .object({
    provider: z.enum(["github", "github_enterprise", "gitea", "forgejo", "gitlab"]),
...
export const GitIntegrationForm = ({ projectId, integration }: GitIntegrationFormProps) => {
  ...
  const repoPlaceholder = provider === "gitlab" ? "group/project or numeric id" : "owner/repo";
