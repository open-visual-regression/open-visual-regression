        ...
        <Card size="default">
          <CardContent className="flex flex-col gap-5">
            ...
            <div className="flex flex-row gap-3">
              <FieldGroup>
                <Field data-invalid={!!errors.baselineGitBranch}>
                  <FieldLabel>baseline git branch</FieldLabel>
                  <Input
                    id="baselineGitBranch"
                    placeholder="enter the baseline git branch"
                    aria-invalid={!!errors.baselineGitBranch}
                    {...register("baselineGitBranch")}
                  />
                  <FieldError errors={[errors.baselineGitBranch]} />
                </Field>
              </FieldGroup>
              <FieldGroup>
