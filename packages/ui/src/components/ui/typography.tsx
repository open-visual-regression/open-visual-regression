...
const typographyVariants = cva("font-mono", {
  variants: {
    variant: {
      display:
        "text-[56px] font-medium tracking-[-0.03em] leading-[1.15]",
      ...
      caption:
        "text-[11px] font-normal leading-[1.5] text-muted-foreground",
      label:
        "text-[11px] font-semibold tracking-[0.08em] uppercase text-ovr-fg-secondary",
